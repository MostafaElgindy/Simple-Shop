...
using Simple_shop_OOP.Domin.OrderManagement;
using Simple_shop_OOP.Domin.ProductManagement;
using System;
...
namespace Simple_shop_OOP
{
    internal class Utilities
    {
        ...
        private static void ShowCreateNewProduct()
        {
            ...
            int newId = int.Parse(Console.ReadLine());//find highest id and increase with 1
